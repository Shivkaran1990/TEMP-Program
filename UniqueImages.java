...
public class UniqueImages {
	...
	public static class Image {
        ...
        /*
        * SHIV :
        * HashCode Implementation is needed as
        * if two object has same hashcode equals will not be called ,
        * */
        public int hashCode(){
			int hashCode=filename.split("\\.")[0].hashCode()+height*width;
        	return hashCode;
